...
/**
 * Constructs the shuttle.
 * 
 * @author Pal Hargitai (pal@lunarray.org)
 * @param <P>
 *            The property type.
 */
public final class ShuttleSelectPropertyStrategy<P>
		extends AbstractSelectFieldPropertyStrategy<P> {

	/** Serial id. */
	private static final long serialVersionUID = 890351001027023742L;
	 ...
	 */
	protected ShuttleSelectPropertyStrategy(final Descriptor<P> descriptor, final RenderContext<?> context) {
	...
	public static final class Factory
		...
		public <P> FormPropertyRenderStrategy<P> createStrategy(final Descriptor<P> descriptor, final RenderContext<?> context) {
			...
			return new ShuttleSelectPropertyStrategy<P>(descriptor, context);
		}
	}
}
